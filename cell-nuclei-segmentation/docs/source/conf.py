...
# cell_nuclei_segmentation documentation build
...
from cell_nuclei_segmentation import __version__ as release

# -- Project information -----------------------------------------------------

project = "cell_nuclei_segmentation"
author = "Kedro"
...
htmlhelp_basename = "cell_nuclei_segmentationdoc"
...
latex_documents = [
    (
        master_doc,
        "cell_nuclei_segmentation.tex",
        "cell_nuclei_segmentation Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cell_nuclei_segmentation",
        "Project cell_nuclei_segmentation codebase.",
        "Data-Science",
    )
]
